// app/portfolio/portfolioResponsiveConfig.ts
...
export const aboutMeRc = {
  ...
  rail: {
    ...
    lineTop:
      "h-20 w-px bg-gradient-to-b from-cyan-300/60 to-transparent",

    text:
      "font-mono text-[10px] uppercase tracking-[0.3em] text-blue-100/40 [writing-mode:vertical-rl]",

    lineBottom:
      "h-20 w-px bg-gradient-to-b from-transparent to-cyan-300/60",

    dotInactive:
      "h-2 w-2 rounded-full border border-cyan-300/60",
  },
  ...
  profile: {
    ...
    desktopInner:
      "relative h-[1100px] w-[1100px]",

    desktopGlow:
      "absolute inset-0 rounded-full bg-blue-500/10 blur-[80px]",
  ...
  floatingFields: {
    base:
      "pointer-events-none absolute z-[30] hidden overflow-visible lg:block",

    left:
      "left-[0%] top-[8%] h-[76%] w-[80%]",

    right:
      "right-[0%] top-[8%] h-[76%] w-[80%]",
  },
  ...
  layout: {
    ...
    grid:
      "relative z-40 mx-auto grid min-h-[calc(100vh-12rem)] w-full max-w-[1800px] grid-cols-1 items-start gap-10 lg:grid-cols-[minmax(360px,500px)_1fr] lg:items-stretch",

    // Left column: headline, paragraph, CTA buttons, mobile profile image.
    leftColumn:
      "flex max-w-[520px] flex-col justify-start",
  ...
  text: {
    eyebrow:
      "mb-5 text-sm uppercase tracking-[0.42em] text-blue-200/60",
    ...
    subtitle:
      "mt-9 text-2xl font-semibold text-white",
  ...
  cards: {
    ...
    grid:
      "grid translate-y-12 grid-cols-1 gap-4 md:grid-cols-3",

    // Regular card.
    card:
      "rounded-2xl border border-blue-300/20 bg-blue-950/30 p-4 backdrop-blur-md xl:p-5",
    ...
    icon:
      "mb-3 h-7 w-7 text-blue-300",

    iconCentered:
      "mx-auto mb-3 h-7 w-7 text-blue-300",

    title:
      "text-xl font-semibold",

    body:
      "mt-3 text-[15px] leading-6 text-white/60",

    smallBody:
      "mt-3 text-[14.6px] leading-6 text-white/60",
...
export const servicesRc = {
  ...
  background: {
    ...
    glow:
      "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(0,220,255,0.16),transparent_45%)]",

    // Cyan technical grid overlay.
    grid:
      "pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(0,220,255,0.16)_1px,transparent_1px),linear-gradient(90deg,rgba(0,220,255,0.16)_1px,transparent_1px)] bg-[size:42px_42px] opacity-40",
  },
  ...
  mobile: {
    ...
    eyebrow:
      "text-xs uppercase tracking-[0.22em] text-cyan-200",

    heading:
      "mt-6 text-2xl leading-snug text-cyan-300",
  ...
  desktop: {
    ...
    leftAside:
      "border border-cyan-400/30 p-8 font-mono text-sm",

    leftEyebrow:
      "mb-6 text-cyan-200",

    leftTextStack:
      "space-y-4 text-cyan-300/80",

    // Desktop about-me block inside left sidebar.
    aboutBlock:
      "mt-10 border-t border-cyan-400/25 pt-8",

    aboutHeader:
      "mb-6 flex items-center justify-between gap-5",
    ...
    aboutText:
      "leading-6 text-cyan-300/70",

    mishiWrapper:
      "relative mt-6 w-full overflow-hidden",

    mishiImage:
      "h-[300px] w-full object-cover opacity-50",
    ...
    cardStage:
      "relative z-10 mt-8 h-[560px]",

    // Right desktop sidebar with three stacked panels.
    rightAside:
      "grid h-full grid-rows-3 gap-3 font-mono",
  },
  ...
  serviceCard: {
    ...
    number:
      "text-xs tracking-[0.25em] text-cyan-400/80",

    title:
      "mt-5 text-xl font-bold text-cyan-100",

    text:
      "mt-5 text-sm leading-6 text-cyan-300/70",
  },
  ...
  sidePanel: {
    base:
      "border border-cyan-400/30 font-mono",
    ...
    items:
      "space-y-4 text-sm text-cyan-300/75",
  },
};
...
export const processRc = {
  ...
  background: {
    ...
    grid:
      "pointer-events-none absolute inset-0 z-[1] bg-[linear-gradient(rgba(34,211,238,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.08)_1px,transparent_1px)] bg-[size:42px_42px] opacity-70",
  },

  // Discount popup placement.
  discount: {
    desktop:
      "absolute left-4 top-4 z-30 hidden font-mono lg:block",

    mobile:
      "mx-auto mt-10 flex justify-center lg:hidden",
  },
  ...
  header: {
    ...
    eyebrow:
      "font-mono text-xs text-blue-400 sm:text-sm",
    ...
    text:
      "mx-auto mt-7 max-w-xl text-base leading-7 text-white/55 sm:text-lg sm:leading-8",
  },

  // Mobile card layout.
  mobile: {
    grid:
      "mt-12 grid grid-cols-1 gap-5 md:hidden",

    card:
      "relative overflow-hidden rounded-3xl border p-5 shadow-[inset_0_0_28px_rgba(59,130,246,0.06)] backdrop-blur-md",
    ...
    iconSvg:
      "h-8 w-8 translate-x-[1px] -translate-y-[1px]",
    ...
    text:
      "mt-3 text-sm leading-7 text-white/60",
    ...
    chip:
      "rounded-full border px-3 py-1.5 text-[11px] font-medium leading-none tracking-wide",
  },

  // Desktop process timeline.
  desktop: {
    wrapper:
      "relative mt-24 hidden md:block",

    line:
      "absolute left-[7%] right-[7%] top-[90px] h-[2px] bg-gradient-to-r from-blue-500 via-violet-500 to-cyan-300 shadow-[0_0_18px_rgba(59,130,246,0.7)]",

    grid:
      "grid grid-cols-4 gap-8 xl:gap-12",

    card:
      "relative",

    topRow:
      "mb-8 flex items-center gap-7",
    ...
    iconSvg:
      "h-10 w-10 translate-x-[1px] -translate-y-[2px]",

    dot:
      "absolute bottom-[-10px] left-1/2 h-5 w-5 -translate-x-1/2 rounded-full",

    title:
      "text-2xl font-semibold text-white",

    text:
      "mt-4 max-w-[260px] text-base leading-7 text-white/60",
    ...
    itemStack:
      "space-y-3 text-sm text-white/65",
  },
  ...
  footer: {
    ...
    line:
      "h-px flex-1 bg-blue-400/20",

    star:
      "text-2xl md:text-3xl",

    text:
      "mx-auto mt-8 max-w-2xl text-center text-sm leading-7 text-white/35 sm:text-base md:text-lg",
  },
};
...
export const goodbyeRc = {
  ...
  background: {
    gridWrapper:
      "pointer-events-none absolute inset-0 opacity-35 md:opacity-40",

    grid:
      "absolute inset-0 bg-[linear-gradient(rgba(34,211,238,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.08)_1px,transparent_1px)] bg-[size:42px_42px]",
  ...
  desktop: {
    wrapper:
      "hidden items-center gap-16 lg:grid lg:grid-cols-[1.05fr_0.95fr]",
  ...
  intro: {
    ...
    ctaArea:
      "mt-8 flex flex-col items-center gap-4 md:mt-10",
  ...
  contact: {
    ...
    rows:
      "relative divide-y divide-cyan-300/10",

    footer:
      "relative p-4 sm:p-6 md:p-7",
    ...
    footerHeart:
      "h-5 w-5 shrink-0 object-contain opacity-90",
  },
  ...
  contactRow: {
    ...
    left:
      "flex min-w-0 items-center gap-4 sm:gap-5",
    ...
    value:
      "mt-1 truncate font-mono text-xs text-cyan-300 sm:text-sm",
  ...
  blob: {
    ...
    line:
      "hidden h-px w-40 items-center justify-center bg-cyan-300/30 sm:flex md:w-72",
...
export const portfolioRc = {
  ...
  // Page-level controls.
  page: {
    // Fixed bottom-right home button that stays visible while scrolling.
    backButtonWrap:
      "fixed bottom-6 right-6 z-[200] sm:bottom-8 sm:right-8",
    ...
    // House icon sizing and hover effect.
    backIcon:
      "h-5 w-5 text-white transition-transform duration-200 group-hover:scale-110 sm:h-6 sm:w-6",
  },
} as const;