...
export const portfolioRc = {
  ...
  neonHero: {
    ...
    logoLink: "relative z-20 inline-block",
    logoImage: "h-22 w-auto object-contain",
    main:
    ...
    textBlock: "w-full max-w-[760px] text-left",
    title:
    ...
    titleWordOne: "neon-word neon-word-1 block",
    titleWordTwo: "neon-word neon-word-2 block",
    titleWordThree: "neon-word neon-word-3 block",
    titleWordFour: "neon-word neon-word-4 block",
    introWrap: "mt-8 flex items-start gap-6",
    introLine:
    ...
    introText: "max-w-md text-base leading-7 text-white/85 sm:text-lg",
    ctaWrap: "mt-9 flex flex-col justify-start gap-4 sm:flex-row",
    primaryCta:
    ...
    ctaIcon: "h-5 w-5",
    aboutIcon: "h-4 w-4 text-cyan-300",
  },
  ...
  carousel: {
    ...
    navIcon: "h-5 w-5",
    cardStage: "relative flex h-[540px] w-full items-center justify-center",
    cardBase: "absolute transition-all duration-500 ease-out",
    cardFeatured:
    ...
    dot: "h-2.5 w-2.5 rounded-full transition",
    dotActive: "bg-cyan-300 shadow-[0_0_14px_rgba(34,211,238,1)]",
    dotInactive: "bg-cyan-100/25 hover:bg-cyan-100/50",
    article:
    ...
    articleInner: "relative z-20 flex h-full flex-col",
    articleTop: "flex items-start justify-between gap-4",
    title: "font-mono uppercase tracking-[0.08em] text-cyan-100",
    titleFeatured: "text-2xl",
    titleNormal: "text-lg",
    subtitle: "mt-3 max-w-[14rem] text-sm leading-5 text-cyan-100/65",
    menuIcon:
    ...
    bottomRow: "mt-auto flex items-center justify-between",
    tag: "text-[10px] uppercase tracking-[0.25em] text-cyan-100/40",
    value: "mt-1 font-mono text-xl text-cyan-200",
    link:
  ...
  projectsHero: {
    section: "relative min-h-screen overflow-hidden bg-transparent text-white",
    background:
    ...
    topRailWrap: "pointer-events-none absolute left-8 top-8 z-20",
    topRail: "mt-5 h-16 border-l border-cyan-300/70 pl-4",
    topRailMainLine:
      "h-1 w-24 bg-cyan-300/70 shadow-[0_0_16px_rgba(34,211,238,0.65)]",
    topRailLineLong: "mt-3 h-px w-32 bg-white/10",
    topRailLineShort: "mt-2 h-px w-20 bg-white/10",
    ...
    centerInner: "relative flex w-full max-w-6xl flex-col items-center",
    titleWrap:
    ...
    exclamation: "neon-word neon-word-2 block",
    titleGlow:
    ...
    ctaWrap: "mt-14 flex flex-col items-center justify-center gap-5 md:flex-row",
    primaryCta:
    ...
    primaryCtaIcon: "ml-3 inline-block transition group-hover:translate-x-1",
    secondaryCta:
    ...
    bottomRailWrap: "pointer-events-none absolute bottom-8 left-8 z-20",
    bottomRail: "mt-4 flex items-center gap-3",
    bottomDotStrong:
      "h-1.5 w-1.5 rounded-full bg-cyan-300 shadow-[0_0_10px_rgba(34,211,238,0.8)]",
    bottomDotMedium: "h-1.5 w-1.5 rounded-full bg-cyan-300/70",
    bottomDotSoft: "h-1.5 w-1.5 rounded-full bg-cyan-300/40",
    bottomLine: "h-px w-28 bg-white/20",
  },

  identity: {
    section: "relative min-h-screen w-full overflow-hidden text-white",
    rail:
    ...
    railDots: "absolute left-[-2px] top-[48%] flex flex-col gap-3",
    railDotOne: "h-1 w-1 rounded-full bg-blue-200/80",
    railDotTwo: "h-1 w-1 rounded-full bg-blue-200/60",
    railDotThree: "h-1 w-1 rounded-full bg-blue-200/40",
    railDotFour: "h-1 w-1 rounded-full bg-blue-200/30",
    inner:
    ...
    kicker: "mb-8 text-xs uppercase tracking-[0.55em] text-cyan-100/45",
    title:
  ...
  rotatingLogo: {
    ...
    textColumn: "relative z-10 max-w-xl text-left",
    leftDecorLine:
    ...
    kickerRow: "mb-5 flex items-center gap-4",
    kicker:
    ...
    titleDivider: "mt-8 flex items-center gap-4",
    titleDividerLine:
    ...
    tags: "mt-8 flex flex-wrap gap-2",
    miniTag:
    ...
    paragraph: "mt-8 text-base font-medium leading-7 text-[#F3F8FF]/80 sm:text-lg",
    paragraphSecond:
    ...
    coreText: "text-base font-medium leading-7 text-[#F3F8FF]/80 sm:text-lg",
    logoColumn:
  ...
  palette: {
    ...
    topMark: "h-16 border-l border-cyan-300/70 pl-4",
    topMarkMainLine:
      "h-1 w-24 bg-cyan-300/70 shadow-[0_0_16px_rgba(34,211,238,0.65)]",
    topMarkLineLong: "mt-3 h-px w-32 bg-white/10",
    topMarkLineShort: "mt-2 h-px w-20 bg-white/10",
    inner:
      "relative z-10 mx-auto flex min-h-[calc(100vh-12rem)] max-w-7xl flex-col justify-center",
    header: "mb-16 max-w-3xl",
    kicker: "mb-5 font-mono text-xs uppercase tracking-[0.42em] text-white/80",
    title:
    ...
    swatchGlowLeft: "absolute inset-y-0 left-0 w-px bg-white/50",
    swatchGlowRight: "absolute inset-y-0 right-0 w-px bg-black/30",
    swatchGlowBlur: "absolute left-0 top-0 h-full w-16 bg-white/10 blur-2xl",
    swatchTop: "relative z-10 flex items-start justify-between gap-4",
    index: "font-mono text-[10px] uppercase tracking-[0.32em] opacity-70",
    hex:
      "origin-top-right rotate-90 whitespace-nowrap font-mono text-[9px] uppercase tracking-[0.22em] opacity-70",
    swatchText: "relative z-10 min-w-0 overflow-hidden",
    colorName:
    ...
    bottomLine: "relative z-10 h-px w-full bg-current opacity-20",
    bottomMarkWrap: "pointer-events-none absolute bottom-8 left-8 z-20",
    bottomMark: "flex items-center gap-3",
    bottomDotStrong:
      "h-1.5 w-1.5 rounded-full bg-cyan-300 shadow-[0_0_10px_rgba(34,211,238,0.8)]",
    bottomDotMedium: "h-1.5 w-1.5 rounded-full bg-cyan-300/70",
    bottomDotSoft: "h-1.5 w-1.5 rounded-full bg-cyan-300/40",
    bottomMarkLine: "h-px w-28 bg-white/20",
  },

  description: {
    section:
      "relative min-h-screen overflow-hidden bg-transparent px-6 py-20 text-[#F3F8FF] sm:px-10 lg:px-16",
    inner: "relative z-10 mx-auto max-w-7xl",
    textContent: "relative z-20 max-w-3xl",
    infoBlock: "mb-7",
    infoTitle:
    ...
    tagWrap: "mt-4 flex flex-wrap gap-2",
    tag:
    ...
    blogParagraph: "mt-5",
    blogLink: "inline-block hover:opacity-80",
    blogLinkText:
      "inline-block overflow-visible animate-rainbow-text pb-[0.14em] font-semibold leading-[1.2]",
    windowsWrap:
    ...
    xpTitleLeft: "flex min-w-0 items-center gap-1.5",
    xpFolderIcon:
      "h-3 w-3 shrink-0 rounded-sm bg-[#f7d24c] shadow-[inset_-1px_-1px_0_rgba(0,0,0,0.28)]",
    xpTitleText: "truncate text-[11px] font-bold leading-none drop-shadow",
    xpControls: "flex shrink-0 items-center gap-1",
    xpControlBlue:
    ...
    xpBody: "border-x-2 border-b-2 border-[#1b55b9] bg-[#ece9d8] p-2",
    xpImageFrame:
      "relative aspect-[3/4] overflow-hidden border border-[#8a867a] bg-white",
    xpImage: "object-cover object-center",
  },
  ...
  selectedProjects: {
    ...
    header: "mx-auto mb-14 max-w-5xl text-center",
    title:
    ...
    cardsArea: "relative mx-auto w-full max-w-6xl",
    desktopArrow:
    ...
    desktopArrowLeft: "left-[-4.5rem]",
    desktopArrowRight: "right-[-4.5rem]",
    desktopArrowIcon: "h-6 w-6",
    mobileArrows: "mb-6 flex justify-center gap-4 lg:hidden",
    mobileArrow:
    ...
    mobileArrowIcon: "h-5 w-5",
    grid: "grid gap-7 lg:grid-cols-3",
    cardBase:
    ...
    cardLeft: "lg:rotate-[-2.5deg]",
    cardCenter: "lg:-translate-y-3",
    cardRight: "lg:rotate-[2.5deg]",
    imageWrap: "absolute inset-0 flex items-center justify-center p-8",
    image:
    ...
    category: "mt-4 text-xs font-medium text-slate-200/85",
    divider: "mt-7 h-px w-full bg-cyan-100/15",
    caseStudyRow: "mt-7 flex items-center justify-between",
    caseStudyText:
      "text-[0.68rem] font-black uppercase tracking-[0.42em] text-cyan-50",
    caseStudyIcon:
      "h-4 w-4 text-cyan-50 transition group-hover:translate-x-1",
    dots: "mt-10 flex justify-center gap-2",
    dot: "h-2 rounded-full transition",
    dotActive:
      "w-8 bg-cyan-200 shadow-[0_0_16px_rgba(103,232,249,0.9)]",
    dotInactive: "w-2 bg-cyan-200/30 hover:bg-cyan-200/60",
  },
  ...
  iconNav: {
    ...
    animatedItem: "will-change-transform will-change-opacity",
    link: "group block rounded-2xl focus:outline-none focus:ring-2 focus:ring-white/60",
    item:
    ...
    iconWrap: "relative flex h-12 w-12 items-center justify-center",
    image:
