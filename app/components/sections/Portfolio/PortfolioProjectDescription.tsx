...
const portraitWindows = [
  ...
  },
  {
    ...
    className:
      "lg:left-[66%] lg:top-[6%] lg:translate-x-[90px] lg:rotate-[2deg] lg:z-20",
  },
  {
    ...
    className:
      "lg:left-[83%] lg:top-[8%] lg:translate-x-[90px] lg:rotate-[6deg] lg:z-30",
  },
  {
    ...
    className:
      "lg:left-[49%] lg:top-[52%] lg:translate-x-[90px] lg:rotate-[4deg] lg:z-20",
  },
  {
    ...
    className:
      "lg:left-[66%] lg:top-[52%] lg:translate-x-[90px] lg:rotate-[-3deg] lg:z-30",
  },
  {
    ...
    className:
      "lg:left-[83%] lg:top-[53%] lg:translate-x-[90px] lg:rotate-[5deg] lg:z-10",
  },
];
